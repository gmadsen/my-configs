...
beautiful.init("/home/madsen/.config/awesome/default/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
	...
	--
	local names = { "main", "www", "dev", "4", "5", "6", "7", "8", "9" }
...
globalkeys = gears.table.join(
	...
	end, { description = "raise screen brightness", group = "awesome" }),
	awful.key({}, "#232", function()
		awful.util.spawn("xbacklight -dec 10")
	end, { description = "lower screen brightness", group = "awesome" })
)
